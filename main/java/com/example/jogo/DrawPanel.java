...
public class DrawPanel extends JPanel implements KeyListener {
    ...
    public void initialize() {
        ...
        player = new Entity(0, 300, 2, 60, 50, 50);
        boss = null;
        lives = 5;
        model_level = 1;
        speed_level = 1;
    ...
    public void initGifs() {
        ...
        try {
            imgs[0] = ImageIO.read(new File("Imagens" + File.separator + "space2.jpg"));
            imgs[1] = ImageIO.read(new File("Imagens" + File.separator + "Nave1.gif"));
            imgs[2] = ImageIO.read(new File("Imagens" + File.separator + "Nave3.gif"));
            imgs[3] = ImageIO.read(new File("Imagens" + File.separator + "Nave2.gif"));
            imgs[4] = ImageIO.read(new File("Imagens" + File.separator + "xtralife.gif"));
            imgs[5] = ImageIO.read(new File("Imagens" + File.separator + "shipupgrade.gif"));
            imgs[6] = ImageIO.read(new File("Imagens" + File.separator + "attackupgrade.gif"));
            imgs[7] = ImageIO.read(new File("Imagens" + File.separator + "rateupgrade.gif"));
            imgs[8] = ImageIO.read(new File("Imagens" + File.separator + "speedupgrade.gif"));
            imgs[9] = ImageIO.read(new File("Imagens" + File.separator + "bullet1.gif"));
            imgs[10] = ImageIO.read(new File("Imagens" + File.separator + "bullet2.gif"));
            imgs[11] = ImageIO.read(new File("Imagens" + File.separator + "bullet3.gif"));
            imgs[12] = ImageIO.read(new File("Imagens" + File.separator + "BBullet.gif"));
            imgs[13] = ImageIO.read(new File("Imagens" + File.separator + "enemy1.gif"));
            imgs[14] = ImageIO.read(new File("Imagens" + File.separator + "enemy2.gif"));
            imgs[15] = ImageIO.read(new File("Imagens" + File.separator + "enemy3.gif"));
            imgs[16] = ImageIO.read(new File("Imagens" + File.separator + "enemy4.gif"));
            imgs[17] = ImageIO.read(new File("Imagens" + File.separator + "enemy5.gif"));
            imgs[18] = ImageIO.read(new File("Imagens" + File.separator + "enemy6.gif"));
            imgs[19] = ImageIO.read(new File("Imagens" + File.separator + "enemy7.gif"));
            imgs[20] = ImageIO.read(new File("Imagens" + File.separator + "enemy8.gif"));
            imgs[21] = ImageIO.read(new File("Imagens" + File.separator + "enemy9.gif"));
            imgs[22] = ImageIO.read(new File("Imagens" + File.separator + "enemy10.gif"));
            imgs[23] = ImageIO.read(new File("Imagens" + File.separator + "enemy11.gif"));
            imgs[24] = ImageIO.read(new File("Imagens" + File.separator + "enemy12.gif"));
            imgs[25] = ImageIO.read(new File("Imagens" + File.separator + "enemy13.gif"));
            imgs[26] = ImageIO.read(new File("Imagens" + File.separator + "enemy14.gif"));
            imgs[27] = ImageIO.read(new File("Imagens" + File.separator + "gold.gif"));
            imgs[28] = ImageIO.read(new File("Imagens" + File.separator + "boss1.gif"));
            imgs[29] = ImageIO.read(new File("Imagens" + File.separator + "boss2.gif"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void initWav() {
        ...
        files[0] = new File("Sons" + File.separator + "Funky_Drum_n_Bass.wav");
        files[1] = new File("Sons" + File.separator + "laser.wav");
        files[2] = new File("Sons" + File.separator + "lose.wav");
        files[3] = new File("Sons" + File.separator + "missileblast.wav");
        files[4] = new File("Sons" + File.separator + "plwing.wav");
        files[5] = new File("Sons" + File.separator + "pst.wav");
        try {
            for (int i = 0; i < 6; i++) {
                audioIn[i] = AudioSystem.getAudioInputStream(files[i]);
    ...
    public void drawMenu() {
        ...
        g.drawString("Or Q to Quit", 380, 350);
        g.drawString("High Score: " + highscore, 350, 550);
        g.dispose();
        try {
            Thread.sleep(50);
        } catch (Exception e) {
    ...
    public void startGame() {
        ...
        while (!quit) {
            ...
            try {
                if (kills < level && level < 6) {
                    kills = 0;
                    level++;
                }
                enemy_counter++;
                if (enemy_counter > (1000 / (level * 2)) && level < 6) {
                    if (enemy[en] == null) {
                        enemy[en] = new Entity(800, (int) (Math.random() * 600), 1, 100, 50, 50);
                        enemy[en].skin = 13 + (int) (Math.random() * (3 * level));//26 - (int)(Math.random()*13);
                ...
                if (level > 5 && boss == null) {
                    boss = new Entity(800, 300, 3, 10, 100, 200);
